...
declare namespace ajv {
  ...
  interface Ajv {
    ...
    * Schema will be compiled and cached (using serialized JSON as key, [fast-json-stable-stringify](https://github.com/AshrafMorningstar is used to serialize by default).
