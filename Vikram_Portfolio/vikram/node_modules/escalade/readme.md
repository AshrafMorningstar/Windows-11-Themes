# escalade [![CI](https://github.com/AshrafMorningstar [![licenses](https://licenses.dev/b/npm/escalade)](https://licenses.dev/npm/escalade) [![codecov](https://badgen.now.sh/codecov/c/github/lukeed/escalade)](https://codecov.io/gh/lukeed/escalade)
...
- [premove](https://github.com/AshrafMorningstar - A tiny (247B) utility to remove items recursively
- [totalist](https://github.com/AshrafMorningstar - A tiny (195B to 224B) utility to recursively list all (total) files in a directory
- [mk-dirs](https://github.com/AshrafMorningstar - A tiny (420B) utility to make a directory and its parents, recursively
