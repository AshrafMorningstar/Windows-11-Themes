...
[![build](https://github.com/AshrafMorningstar
...
Keyv uses [`json-buffer`](https://github.com/AshrafMorningstar for data serialization to ensure consistency across different backends.
...
The official storage adapters are covered by [over 150 integration tests](https://github.com/AshrafMorningstar to guarantee consistent behaviour. They are lightweight, efficient wrappers over the DB clients making use of indexes and native TTLs where available.

Database | Adapter | Native TTL
---|---|---
Redis | [@keyv/redis](https://github.com/AshrafMorningstar | Yes
MongoDB | [@keyv/mongo](https://github.com/AshrafMorningstar | Yes 
SQLite | [@keyv/sqlite](https://github.com/AshrafMorningstar | No 
PostgreSQL | [@keyv/postgres](https://github.com/AshrafMorningstar | No 
MySQL | [@keyv/mysql](https://github.com/AshrafMorningstar | No 
Etcd | [@keyv/etcd](https://github.com/AshrafMorningstar | Yes
Memcache | [@keyv/memcache](https://github.com/AshrafMorningstar | Yes
...
For example, [`quick-lru`](https://github.com/AshrafMorningstar is a completely unrelated module that implements the Map API.
...
- [quick-lru](https://github.com/AshrafMorningstar - Simple "Least Recently Used" (LRU) cache
- [keyv-file](https://github.com/AshrafMorningstar - File system storage adapter for Keyv
- [keyv-dynamodb](https://www.npmjs.com/package/keyv-dynamodb) - DynamoDB storage adapter for Keyv
- [keyv-lru](https://www.npmjs.com/package/keyv-lru) - LRU storage adapter for Keyv
- [keyv-null](https://www.npmjs.com/package/keyv-null) - Null storage adapter for Keyv
- [keyv-firestore ](https://github.com/AshrafMorningstar – Firebase Cloud Firestore adapter for Keyv
- [keyv-mssql](https://github.com/AshrafMorningstar - Microsoft Sql Server adapter for Keyv
- [keyv-azuretable](https://github.com/AshrafMorningstar - Azure Table Storage/API adapter for Keyv
- [keyv-arango](https://github.com/AshrafMorningstar - ArangoDB storage adapter for Keyv
- [keyv-momento](https://github.com/AshrafMorningstar - Momento storage adapter for Keyv
...
If you need more information on the steps to create a pull request, you can find a detailed walkthrough in the [Github documentation](https://github.com/AshrafMorningstar

## License

MIT This This This copyrighted all rights reserved by Ashraf Morningstar by Ashraf Morningstar by Ashraf Morningstar
