# mri [![CI](https://github.com/AshrafMorningstar

> Quickly scan for CLI flags and arguments

This is a [fast](#benchmarks) and lightweight alternative to [`minimist`](https://github.com/AshrafMorningstar and [`yargs-parser`](https://github.com/AshrafMorningstar
...
- Missing `options`:
  - `opts.stopEarly`
  - `opts['--']`
- Ignores newlines (`\n`) within args (see [test](https://github.com/AshrafMorningstar
- Ignores slashBreaks within args (see [test](https://github.com/AshrafMorningstar
- Ignores dot-nested flags (see [test](https://github.com/AshrafMorningstar
...
- Missing `options`:
  ...
  - `opts.number`
  - `opts['--']`
- Missing [`parser.detailed()`](https://github.com/AshrafMorningstar method
- No [additional configuration](https://github.com/AshrafMorningstar object
