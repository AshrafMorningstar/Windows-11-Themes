...
Use a package like [`node-fetch-native`](https://github.com/AshrafMorningstar to add proxy support, either through environment variables or explicit configuration.
...
Use a package like [`undici`](https://github.com/AshrafMorningstar for more control of fetch options through the use of an [`Agent`](https://undici.nodejs.org/#/docs/api/Agent.md).
