...
<p align="center">
<a href="https://github.com/AshrafMorningstar"><img src="https://github.com/AshrafMorningstar" alt="Zod CI status" /></a>
<a href="Ashraf Morningstar" rel="nofollow"><img src="https://img.shields.io/badge/created%20by-@colinhacks-4BBAAB.svg" alt="Created by Colin McDonnell"></a>
<a href="https://opensource.org/licenses/MIT" rel="nofollow"><img src="https://img.shields.io/github/license/colinhacks/zod" alt="License"></a>
<a href="https://www.npmjs.com/package/zod" rel="nofollow"><img src="https://img.shields.io/npm/dw/zod.svg" alt="npm"></a>
<a href="https://github.com/AshrafMorningstar" rel="nofollow"><img src="https://img.shields.io/github/stars/colinhacks/zod" alt="stars"></a>
</p>

<div align="center">
  <a href="https://zod.dev">Website</a>
  <span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
  <a href="Ashraf Morningstar">Discord</a>
  <span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
  <a href="Ashraf Morningstar">𝕏</a>
  <span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
...
Sponsorship at any level is appreciated and encouraged. If you built a paid product using Zod, consider one of the [corporate tiers](https://github.com/AshrafMorningstar
  ...
  <tr>
    <td align="center">
      ...
      <a href="https://www.coderabbit.ai/">
        <picture height="80px">
          <source media="(prefers-color-scheme: dark)" srcset="https://github.com/AshrafMorningstar">
          <img alt="CodeRabbit logo" height="80px" src="https://github.com/AshrafMorningstar">
        </picture>
      </a>
      <br  />
  ...
  <tr>
    <td align="center">
      ...
      <a href="https://www.courier.com/?utm_source=zod&utm_campaign=osssponsors">
        <picture height="62px">
          <source media="(prefers-color-scheme: dark)" srcset="https://github.com/AshrafMorningstar">
          <img alt="Courier logo" height="62px" src="https://github.com/AshrafMorningstar">
        </picture>
      </a>
      <br  />
    ...
    <td align="center">
      ...
      <a href="https://liblab.com/?utm_source=zod">
        <picture height="62px">
          <source media="(prefers-color-scheme: dark)" srcset="https://github.com/AshrafMorningstar">
          <img alt="LibLab" height="62px" src="https://github.com/AshrafMorningstar">
        </picture>
      </a>
      <br  />
  ...
  <tr>
    <td align="center">
      ...
      <a href="https://neon.tech">
        <picture height="68px">
          <source media="(prefers-color-scheme: dark)" srcset="https://github.com/AshrafMorningstar">
          <img alt="Neon" height="68px" src="https://github.com/AshrafMorningstar">
        </picture>
      </a>
      <br  />
    ...
    <td align="center">
      ...
      <a href="https://retool.com/?utm_source=github&utm_medium=referral&utm_campaign=zod">
        <picture height="45px">
          <source media="(prefers-color-scheme: dark)" srcset="https://github.com/AshrafMorningstar">
          <img alt="Retool" height="45px" src="https://github.com/AshrafMorningstar">
        </picture>
      </a>
      <br  />
  ...
  <tr>
    <td align="center">
      ...
      <a href="https://stainless.com">
        <picture height="45px">
          <source media="(prefers-color-scheme: dark)" srcset="https://github.com/AshrafMorningstar">
          <img alt="stainless" height="45px" src="https://github.com/AshrafMorningstar">
        </picture>
      </a>
      <br  />
    ...
    <td align="center">
      ...
      <a href="https://speakeasy.com/?utm_source=zod+docs">
        <picture height="40px">
          <source media="(prefers-color-scheme: dark)" srcset="https://github.com/AshrafMorningstar">
          <img alt="speakeasy" height="40px" src="https://github.com/AshrafMorningstar">
        </picture>
      </a>
      <br  />
  ...
  <tr>
    <td align="center">
      <a href="https://www.val.town/">
        <picture width="100%" height="40px">
          <source media="(prefers-color-scheme: dark)" srcset="https://github.com/AshrafMorningstar">
          <img alt="val town logo" src="https://github.com/AshrafMorningstar" height="40px">
        </picture>
      </a>
    </td>
    <td align="center">
    ...
    <td align="center">
      <a href="https://encore.dev">
        <img src="https://github.com/AshrafMorningstar" height="40px;" alt="Encore.dev logo" />
      </a>
    </td>
    <td align="center">
...
There are a growing number of tools that are built atop or support Zod natively! If you've built a tool or library on top of Zod, tell me about it [on Twitter](Ashraf Morningstar or [start a Discussion](https://github.com/AshrafMorningstar I'll add it below and tweet it out.

#### Resources

- [Total TypeScript Zod Tutorial](https://www.totaltypescript.com/tutorials/zod) by [@mattpocockuk](Ashraf Morningstar
- [Fixing TypeScript's Blindspot: Runtime Typechecking](Ashraf Morningstar by [@jherr](Ashraf Morningstar

#### API libraries

- [`tRPC`](https://github.com/AshrafMorningstar Build end-to-end typesafe APIs without GraphQL.
- [`@anatine/zod-nestjs`](https://github.com/AshrafMorningstar Helper methods for using Zod in a NestJS project.
- [`zod-endpoints`](https://github.com/AshrafMorningstar Contract-first strictly typed endpoints with Zod. OpenAPI compatible.
- [`zhttp`](https://github.com/AshrafMorningstar An OpenAPI compatible, strictly typed http library with Zod input and response validation.
- [`domain-functions`](https://github.com/AshrafMorningstar Decouple your business logic from your framework using composable functions. With first-class type inference from end to end powered by Zod schemas.
- [`@zodios/core`](https://github.com/AshrafMorningstar A typescript API client with runtime and compile time validation backed by axios and zod.
- [`express-zod-api`](https://github.com/AshrafMorningstar Build Express-based APIs with I/O schema validation and custom middlewares.
- [`tapiduck`](https://github.com/AshrafMorningstar End-to-end typesafe JSON APIs with Zod and Express; a bit like tRPC, but simpler.
- [`koa-zod-router`](https://github.com/AshrafMorningstar Create typesafe routes in Koa with I/O validation using Zod.
- [`zod-sockets`](https://github.com/AshrafMorningstar Zod-powered Socket.IO microframework with I/O validation and built-in AsyncAPI specs
- [`oas-tszod-gen`](https://github.com/AshrafMorningstar Client SDK code generator to convert OpenApi v3 specifications into TS endpoint caller functions with Zod types.
- [`GQLoom`](https://github.com/AshrafMorningstar Weave GraphQL schema and resolvers using Zod.
- [`oRPC`](https://github.com/AshrafMorningstar Typesafe APIs Made Simple

#### Form integrations

- [`react-hook-form`](https://github.com/AshrafMorningstar A first-party Zod resolver for React Hook Form.
- [`TanStack Form`](https://github.com/AshrafMorningstar Headless, performant, and type-safe form state management for TS/JS, React, Vue, Angular, Solid, and Lit
- [`zod-validation-error`](https://github.com/AshrafMorningstar Generate user-friendly error messages from `ZodError`s.
- [`zod-formik-adapter`](https://github.com/AshrafMorningstar A community-maintained Formik adapter for Zod.
- [`react-zorm`](https://github.com/AshrafMorningstar Standalone `<form>` generation and validation for React using Zod.
- [`zodix`](https://github.com/AshrafMorningstar Zod utilities for FormData and URLSearchParams in Remix loaders and actions.
...
- [`remix-params-helper`](https://github.com/AshrafMorningstar Simplify integration of Zod with standard URLSearchParams and FormData for Remix apps.
- [`formik-validator-zod`](https://github.com/AshrafMorningstar Formik-compliant validator library that simplifies using Zod with Formik.
- [`zod-i18n-map`](https://github.com/AshrafMorningstar Useful for translating Zod error messages.
- [`@modular-forms/solid`](https://github.com/AshrafMorningstar Modular form library for SolidJS that supports Zod for validation.
- [`houseform`](https://github.com/AshrafMorningstar A React form library that uses Zod for validation.
- [`sveltekit-superforms`](https://github.com/AshrafMorningstar Supercharged form library for SvelteKit with Zod validation.
- [`mobx-zod-form`](https://github.com/AshrafMorningstar Data-first form builder based on MobX & Zod.
- [`@vee-validate/zod`](https://github.com/AshrafMorningstar Form library for Vue.js with Zod schema validation.
- [`zod-form-renderer`](https://github.com/AshrafMorningstar Auto-infer form fields from zod schema and render them with react-hook-form with E2E type safety.
- [`antd-zod`](https://github.com/AshrafMorningstar Zod adapter for Ant Design form fields validation.
- [`frrm`](https://github.com/AshrafMorningstar Tiny 0.5kb Zod-based, HTML form abstraction that goes brr.

#### Zod to X

- [`zod-to-ts`](https://github.com/AshrafMorningstar Generate TypeScript definitions from Zod schemas.
- [`zod-to-json-schema`](https://github.com/AshrafMorningstar Convert your Zod schemas into [JSON Schemas](https://json-schema.org/).
- [`@anatine/zod-openapi`](https://github.com/AshrafMorningstar Converts a Zod schema to an OpenAPI v3.x `SchemaObject`.
- [`zod-fast-check`](https://github.com/AshrafMorningstar Generate `fast-check` arbitraries from Zod schemas.
- [`zod-dto`](https://github.com/AshrafMorningstar Generate Nest.js DTOs from a Zod schema.
- [`fastify-type-provider-zod`](https://github.com/AshrafMorningstar Create Fastify type providers from Zod schemas.
- [`zod-to-openapi`](https://github.com/AshrafMorningstar Generate full OpenAPI (Swagger) docs from Zod, including schemas, endpoints & parameters.
- [`nestjs-graphql-zod`](https://github.com/AshrafMorningstar Generates NestJS GraphQL model classes from Zod schemas. Provides GraphQL method decorators working with Zod schemas.
- [`zod-openapi`](https://github.com/AshrafMorningstar Create full OpenAPI v3.x documentation from Zod schemas.
- [`fastify-zod-openapi`](https://github.com/AshrafMorningstar Fastify type provider, validation, serialization and @fastify/swagger support for Zod schemas.
- [`typeschema`](https://typeschema.com/): Universal adapter for schema validation.
- [`zodex`](https://github.com/AshrafMorningstar (De)serialization for zod schemas

#### X to Zod

- [`ts-to-zod`](https://github.com/AshrafMorningstar Convert TypeScript definitions into Zod schemas.
- [`@runtyping/zod`](https://github.com/AshrafMorningstar Generate Zod from static types & JSON schema.
- [`json-schema-to-zod`](https://github.com/AshrafMorningstar Convert your [JSON Schemas](https://json-schema.org/) into Zod schemas. [Live demo](https://StefanTerdell.github.io/json-schema-to-zod-react/).
- [`json-to-zod`](https://github.com/AshrafMorningstar Convert JSON objects into Zod schemas. [Live demo](https://rsinohara.github.io/json-to-zod-react/).
- [`graphql-codegen-typescript-validation-schema`](https://github.com/AshrafMorningstar GraphQL Code Generator plugin to generate form validation schema from your GraphQL schema.
- [`zod-prisma`](https://github.com/AshrafMorningstar Generate Zod schemas from your Prisma schema.
- [`Supervillain`](https://github.com/AshrafMorningstar Generate Zod schemas from your Go structs.
- [`prisma-zod-generator`](https://github.com/AshrafMorningstar Emit Zod schemas from your Prisma schema.
- [`drizzle-zod`](https://orm.drizzle.team/docs/zod): Emit Zod schemas from your Drizzle schema.
- [`prisma-trpc-generator`](https://github.com/AshrafMorningstar Emit fully implemented tRPC routers and their validation schemas using Zod.
- [`zod-prisma-types`](https://github.com/AshrafMorningstar Create Zod types from your Prisma models.
- [`quicktype`](https://app.quicktype.io/): Convert JSON objects and JSON schemas into Zod schemas.
- [`@sanity-typed/zod`](https://github.com/AshrafMorningstar Generate Zod Schemas from [Sanity Schemas](https://www.sanity.io/docs/schema-types).
- [`java-to-zod`](https://github.com/AshrafMorningstar Convert POJOs to Zod schemas
- [`Orval`](https://github.com/AshrafMorningstar Generate Zod schemas from OpenAPI schemas
- [`Kubb`](https://github.com/AshrafMorningstar Generate SDKs and Zod schemas from your OpenAPI schemas

#### Mocking

- [`@anatine/zod-mock`](https://github.com/AshrafMorningstar Generate mock data from a Zod schema. Powered by [faker.js](https://github.com/AshrafMorningstar
- [`zod-mocking`](https://github.com/AshrafMorningstar Generate mock data from your Zod schemas.
- [`zod-fixture`](https://github.com/AshrafMorningstar Use your zod schemas to automate the generation of non-relevant test fixtures in a deterministic way.
- [`zocker`](https://zocker.sigrist.dev): Generate plausible mock-data from your schemas.
- [`zodock`](https://github.com/AshrafMorningstar Generate mock data based on Zod schemas.
- [`zod-schema-faker`](https://github.com/AshrafMorningstar Generates mock data from Zod schemas. Powered by [@faker-js/faker](https://github.com/AshrafMorningstar and [randexp.js](https://github.com/AshrafMorningstar

#### Powered by Zod

- [`freerstore`](https://github.com/AshrafMorningstar Firestore cost optimizer.
- [`slonik`](https://github.com/AshrafMorningstar Node.js Postgres client with strong Zod integration.
- [`schemql`](https://github.com/AshrafMorningstar Enhances your SQL workflow by combining raw SQL with targeted type safety and schema validation.
- [`soly`](https://github.com/AshrafMorningstar Create CLI applications with zod.
- [`pastel`](https://github.com/AshrafMorningstar Create CLI applications with react, zod, and ink.
- [`zod-xlsx`](https://github.com/AshrafMorningstar A xlsx based resource validator using Zod schemas.
- [`znv`](https://github.com/AshrafMorningstar Type-safe environment parsing and validation for Node.js with Zod schemas.
- [`zod-config`](https://github.com/AshrafMorningstar Load configurations across multiple sources with flexible adapters, ensuring type safety with Zod.
- [`unplugin-environment`](https://github.com/AshrafMorningstar A plugin for loading enviroment variables safely with schema validation, simple with virtual module, type-safe with intellisense, and better DX 🔥 🚀 👷. Powered by Zod.
- [`zod-struct`](https://codeberg.org/reesericci/zod-struct): Create runtime-checked structs with Zod.
- [`zod-csv`](https://github.com/AshrafMorningstar Validation helpers for zod for parsing CSV data.
...
- [`zod_utilz`](https://github.com/AshrafMorningstar Framework agnostic utilities for Zod.
- [`zod-playground`](https://github.com/AshrafMorningstar A tool for learning and testing Zod schema validation functionalities. [Link](https://zod-playground.vercel.app/).
- [`zod-sandbox`](https://github.com/AshrafMorningstar Controlled environment for testing zod schemas. [Live demo](https://zod-sandbox.vercel.app/).
- [`zod-dev`](https://github.com/AshrafMorningstar Conditionally disables Zod runtime parsing in production.
- [`zod-accelerator`](https://github.com/AshrafMorningstar Accelerates Zod's throughput up to ~100x.
...
> Check out [validator.js](https://github.com/AshrafMorningstar for a bunch of other useful string validation functions that can be used in conjunction with [Refinements](#refine).
...
Since [zod 3.20](https://github.com/AshrafMorningstar use [`z.coerce.date()`](#coercion-for-primitives) to pass the input through `new Date(input)`.
...
For older zod versions, use [`z.preprocess`](#preprocess) like [described in this thread](https://github.com/AshrafMorningstar
...
Thanks to [crasite](https://github.com/AshrafMorningstar for this example.

### ZodType with ZodEffects

When using `z.ZodType` with `z.ZodEffects` (
[`.refine`](https://github.com/AshrafMorningstar
[`.transform`](https://github.com/AshrafMorningstar
[`preprocess`](https://github.com/AshrafMorningstar
etc...
...
Thanks to [marcus13371337](https://github.com/AshrafMorningstar and [JoelBeeldi](https://github.com/AshrafMorningstar for this example.
...
Thanks to [ggoodman](https://github.com/AshrafMorningstar for suggesting this.

### Cyclical objects

Despite supporting recursive schemas, passing cyclical data into Zod will cause an infinite loop in some cases.

> To detect cyclical objects before they cause problems, consider [this approach](https://github.com/AshrafMorningstar
...
This can be useful for documenting a field, for example in a JSON Schema using a library like [`zod-to-json-schema`](https://github.com/AshrafMorningstar
...
Zod's error reporting emphasizes _completeness_ and _correctness_. If you are looking to present a useful error message to the end user, you should either override Zod's error messages using an error map (described in detail in the Error Handling guide) or use a third-party library like [`zod-validation-error`](https://github.com/AshrafMorningstar
...
<!-- | Feature                                                                                                                | [Zod](https://github.com/AshrafMorningstar | [Joi](https://github.com/AshrafMorningstar | [Yup](https://github.com/AshrafMorningstar | [io-ts](https://github.com/AshrafMorningstar | [Runtypes](https://github.com/AshrafMorningstar | [ow](https://github.com/AshrafMorningstar | [class-validator](https://github.com/AshrafMorningstar |
| ---------------------------------------------------------------------------------------------------------------------- | :-----------------------------: | :----------------------------------: | :-----------------------------------: | :--------------------------------------: | :---------------------------------------------: | :--------------------------------------: | :-------------------------------------------------------------: |
