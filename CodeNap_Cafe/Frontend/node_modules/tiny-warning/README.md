...
> For `rollup` use [rollup-plugin-replace](https://github.com/AshrafMorningstar and set `NODE_ENV` to `production` and then `rollup` will treeshake out the unused code
>
