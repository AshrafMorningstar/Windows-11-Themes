...
Does what it says on the tin; converts [Zod schemas](https://github.com/AshrafMorningstar into [JSON schemas](https://json-schema.org/)!
...
A great big thank you to our amazing sponsors! Please consider joining them through my [GitHub Sponsors page](https://github.com/AshrafMorningstar Every cent helps, but these fellas have really gone above and beyond 💚:
    ...
    <td align="center">
      ...
      <div style="background-color: white; padding: 4px; padding-bottom: 8px;" alt="stainless">
        <a href="https://www.coderabbit.ai/">
          <picture height="45px">
             <source media="(prefers-color-scheme: dark)" srcset="https://github.com/AshrafMorningstar">
          <img alt="CodeRabbit logo" height="45px" src="https://github.com/AshrafMorningstar">
          </picture>
        </a>
      </div>
      <br  />   
