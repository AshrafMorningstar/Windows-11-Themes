...
If you are having issues with Nodemailer, then the best way to find help would be [Stack Overflow](https://github.com/AshrafMorningstar or revisit the [docs](https://nodemailer.com/about/).
...
The Nodemailer logo was designed by [Sven Kristjansen](https://www.behance.net/ashraf_morningstar
