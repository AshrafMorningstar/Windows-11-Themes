 ...
 * remove:
   ...
   - express(1) - moved to [express-generator](https://github.com/AshrafMorningstar
 ...
 * refactor:
   - `req.accepts*` with [accepts](https://github.com/AshrafMorningstar
   - `req.is` with [type-is](https://github.com/AshrafMorningstar
   - [path-to-regexp](https://github.com/AshrafMorningstar
 * add:
...
==================
  ...
  * Added [haml.js](https://github.com/AshrafMorningstar submodule; removed haml-js
