...
Lead Maintainer: [Jordan Harband](https://github.com/AshrafMorningstar

The **qs** module was originally created and maintained by [TJ Holowaychuk](https://github.com/AshrafMorningstar
...
This behavior will not change and is explained in [issue #91](https://github.com/AshrafMorningstar
...
If you wish to auto-convert values which look like numbers, booleans, and other values into their primitive counterparts, you can use the [query-types Express JS middleware](https://github.com/AshrafMorningstar which will auto-convert all request query parameters.
...
[`qs-iconv`](https://github.com/AshrafMorningstar library:
...
Please email [@ljharb](https://github.com/AshrafMorningstar or see https://tidelift.com/security if you have a potential security vulnerability to report.
...
[actions-url]: https://github.com/AshrafMorningstar

## Acknowledgements

qs logo by [NUMI](https://github.com/AshrafMorningstar
