...
- To ensure matches work on paths containing characters usually encoded, such as emoji, consider using [encodeurl](https://github.com/AshrafMorningstar for `encodePath`.
...
- **options** _(optional)_
  - **encodePath** A function for encoding input strings. (default: `x => x`, recommended: [`encodeurl`](https://github.com/AshrafMorningstar
...
[build-url]: https://github.com/AshrafMorningstar
