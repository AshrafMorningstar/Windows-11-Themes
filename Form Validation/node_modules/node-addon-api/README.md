...
Are you new to **node-addon-api**? Take a look at our **[examples](https://github.com/AshrafMorningstar

- **[Hello World](https://github.com/AshrafMorningstar
- **[Pass arguments to a function](https://github.com/AshrafMorningstar
- **[Callbacks](https://github.com/AshrafMorningstar
- **[Object factory](https://github.com/AshrafMorningstar
- **[Function factory](https://github.com/AshrafMorningstar
- **[Wrapping C++ Object](https://github.com/AshrafMorningstar
- **[Factory of wrapped object](https://github.com/AshrafMorningstar
- **[Passing wrapped object around](https://github.com/AshrafMorningstar
...
Take a look and get inspired by our **[test suite](https://github.com/AshrafMorningstar
...
- **[Node-API - Next Generation Node API for Native Modules](https://www.youtube.com/@ashraf_morningstar
...
![Node-API v1 Badge](https://github.com/AshrafMorningstar
![Node-API v2 Badge](https://github.com/AshrafMorningstar
![Node-API v3 Badge](https://github.com/AshrafMorningstar
![Node-API v4 Badge](https://github.com/AshrafMorningstar
![Node-API v5 Badge](https://github.com/AshrafMorningstar
![Node-API v6 Badge](https://github.com/AshrafMorningstar
![Node-API v7 Badge](https://github.com/AshrafMorningstar
![Node-API v8 Badge](https://github.com/AshrafMorningstar
![Node-API v9 Badge](https://github.com/AshrafMorningstar
![Node-API Experimental Version Badge](https://github.com/AshrafMorningstar
...
| Name                | GitHub Link                                           |
| ------------------- | ----------------------------------------------------- |
| Anna Henningsen     | [addaleax](https://github.com/AshrafMorningstar               |
| Chengzhong Wu       | [legendecas](https://github.com/AshrafMorningstar           |
| Jack Xia            | [JckXia](https://github.com/AshrafMorningstar                   |
| Kevin Eady          | [KevinEady](https://github.com/AshrafMorningstar             |
| Michael Dawson      | [mhdawson](https://github.com/AshrafMorningstar               |
| Nicola Del Gobbo    | [NickNaso](https://github.com/AshrafMorningstar               |
| Vladimir Morozov    | [vmoroz](https://github.com/AshrafMorningstar                   |

### Emeritus
| Name                | GitHub Link                                           |
| ------------------- | ----------------------------------------------------- |
| Arunesh Chandra     | [aruneshchandra](https://github.com/AshrafMorningstar   |
| Benjamin Byholm     | [kkoopa](https://github.com/AshrafMorningstar                   |
| Gabriel Schulhof    | [gabrielschulhof](https://github.com/AshrafMorningstar |
| Hitesh Kanwathirtha | [digitalinfinity](https://github.com/AshrafMorningstar |
| Jason Ginchereau    | [jasongin](https://github.com/AshrafMorningstar               |
| Jim Schlight        | [jschlight](https://github.com/AshrafMorningstar             |
| Sampson Gao         | [sampsongao](https://github.com/AshrafMorningstar           |
| Taylor Woll         | [boingoing](https://github.com/AshrafMorningstar             |
