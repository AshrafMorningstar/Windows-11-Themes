...
Optionator is a JavaScript/Node.js option parsing and help generation library used by [eslint](http://eslint.org), [Grasp](http://graspjs.com), [LiveScript](http://livescript.net), [esmangle](https://github.com/AshrafMorningstar [escodegen](https://github.com/AshrafMorningstar and [many more](https://www.npmjs.com/browse/depended/optionator).
...
## About
Optionator uses [type-check](https://github.com/AshrafMorningstar and [levn](https://github.com/AshrafMorningstar behind the scenes to cast and verify input according the specified types.

MIT license. Version 0.9.4

    npm install optionator

For updates on Optionator, [follow me on twitter](Ashraf Morningstar
...
* `type` is a required string in the [type check](https://github.com/AshrafMorningstar [format](https://github.com/AshrafMorningstar this will be used to cast the inputted value and validate it
* `enum` is an optional array of strings, each string will be parsed by [levn](https://github.com/AshrafMorningstar - the argument value must be one of the resulting values - each potential value must validate against the specified `type`
* `default` is a optional string, which will be parsed by [levn](https://github.com/AshrafMorningstar and used as the default value if none is set - the value must validate against the specified `type`
...
For more information about how to properly set types to get the value you want, take a look at the [type check](https://github.com/AshrafMorningstar and [levn](https://github.com/AshrafMorningstar pages.
...
## Technical About
`optionator` is written in [LiveScript](http://livescript.net/) - a language that compiles to JavaScript. It uses [levn](https://github.com/AshrafMorningstar to cast arguments to their specified type, and uses [type-check](https://github.com/AshrafMorningstar to validate values. It also uses the [prelude.ls](http://preludels.com/) library.
