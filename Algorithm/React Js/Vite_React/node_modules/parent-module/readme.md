...
Useful if you want it to work [multiple module levels down](https://github.com/AshrafMorningstar


## Tip

Combine it with [`read-pkg-up`](https://github.com/AshrafMorningstar to read the package.json of the parent module.
