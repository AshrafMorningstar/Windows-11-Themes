...
function isNullLiteral(node) {
	 ...
	 * `node.regex` instead. Also see: https://github.com/AshrafMorningstar
	 */
	return (
		node.type === "Literal" &&
		node.value === null &&
...
module.exports = {
	...
	getFunctionNameWithKind(node) {
		...
		if (
			...
			// The proposal uses `static` word consistently before visibility words: https://github.com/AshrafMorningstar
			if (parent.static) {
				tokens.push("static");
			}
