...
[deep-equal](https://github.com/AshrafMorningstar except for the fact that `deepEqual(NaN, NaN) === true`.

This module is around [5 times faster](https://github.com/AshrafMorningstar
