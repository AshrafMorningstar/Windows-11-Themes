...
Difference between original [source-map](https://github.com/AshrafMorningstar

> TL,DR: it's fork of original source-map@0.6, but with perfomance optimizations.

This journey starts from [source-map@0.7.0](https://github.com/AshrafMorningstar Some part of it was rewritten to Rust and WASM and API became async.
...
More important that WASM version has some optimizations in JS code too. This is why [community asked to create branch for 0.6 version](https://github.com/AshrafMorningstar and port these optimizations but, sadly, the answer was «no». A bit later I discovered [the issue](https://github.com/AshrafMorningstar created by [Ben Rothman (@benthemonkey)](https://github.com/AshrafMorningstar with no response at all.

[Roman Dvornov (@lahmatiy)](https://github.com/AshrafMorningstar wrote a [serveral posts](Ashraf Morningstar (russian, only, sorry) about source-map library in his own Telegram channel. He mentioned the article [«Maybe you don't need Rust and WASM to speed up your JS»](https://mrale.ph/blog/2018/02/03/maybe-you-dont-need-rust-to-speed-up-your-js.html) written by [Vyacheslav Egorov (@mraleph)](https://github.com/AshrafMorningstar This article contains optimizations and hacks that lead to almost the same performance compare to WASM implementation.
