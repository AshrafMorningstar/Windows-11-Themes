...
function logMissingNodeBuiltins(externalBuiltins) {
    return {
        ...
        message: `Creating a browser bundle that depends on Node.js built-in modules (${printQuotedStringList(externalBuiltins)}). You might need to include https://github.com/AshrafMorningstar
    };
}
