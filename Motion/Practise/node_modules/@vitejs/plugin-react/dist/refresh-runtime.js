...
/**
 * This is simplified pure-js version of https://github.com/AshrafMorningstar/react-refresh/src/ReactFreshRuntime.js
...
export function createSignatureFunctionForTransform() {
  ...
  return function (type, key, forceReset, getCustomHooks) {
    if (typeof key === 'string') {
      ...
      // problems like https://github.com/AshrafMorningstar
      if (
        type != null &&
...
// Taken from https://github.com/AshrafMorningstar
...
export function registerExportsForReactRefresh(filename, moduleExports) {
  for (const key in moduleExports) {
    ...
    if (isLikelyComponentType(exportValue)) {
      ...
      // shadow a local component name: https://github.com/AshrafMorningstar
...
// dynamic import is present (https://github.com/AshrafMorningstar
