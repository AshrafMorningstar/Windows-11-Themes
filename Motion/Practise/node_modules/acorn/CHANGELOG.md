...
Add support for the `d` ([indices](https://github.com/AshrafMorningstar regexp flag.
...
Changes the node format for dynamic imports to use the `ImportExpression` node type, as defined in [ESTree](https://github.com/AshrafMorningstar
...
Support [`directive` property](https://github.com/AshrafMorningstar on directive expression statements.
...
Implement the [template literal revision proposal](https://github.com/AshrafMorningstar for ES9.
