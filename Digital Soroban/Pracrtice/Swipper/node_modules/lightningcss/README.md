...
- **Browser-grade parser** – Lightning CSS is built on the [cssparser](https://github.com/AshrafMorningstar and [selectors](https://github.com/AshrafMorningstar crates created by Mozilla and used by Firefox and Servo. These provide a solid general purpose CSS-parsing foundation on top of which Lightning CSS implements support for all specific CSS rules and properties.
...
- **CSS modules** – Lightning CSS supports compiling a subset of [CSS modules](https://github.com/AshrafMorningstar features.
