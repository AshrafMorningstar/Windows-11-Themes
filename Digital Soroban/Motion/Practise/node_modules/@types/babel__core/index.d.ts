...
export interface TransformOptions {
     ...
     * This can either be a [browserslist-compatible](https://github.com/AshrafMorningstar query (with [caveats](https://babeljs.io/docs/en/babel-preset-env#ineffective-browserslist-queries))
     *
     * Default: `{}`
     */
    targets?:
