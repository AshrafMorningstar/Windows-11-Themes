...
const immediateHandlers = {
    MISSING_NODE_BUILTINS(warning) {
        ...
        rollup.stderr(`Creating a browser bundle that depends on ${parseAst_js.printQuotedStringList(warning.ids)}. You might need to include https://github.com/AshrafMorningstar
    },
