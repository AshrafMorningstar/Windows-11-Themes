...
Deterministic `JSON.stringify()` - a faster version of [@substack](https://github.com/AshrafMorningstar's json-stable-strigify without [jsonify](https://github.com/AshrafMorningstar
