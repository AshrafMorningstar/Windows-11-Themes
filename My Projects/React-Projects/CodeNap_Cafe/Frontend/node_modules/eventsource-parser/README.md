...
- [eventsource-client](https://github.com/AshrafMorningstar modern, feature rich eventsource client for browsers, node.js, bun, deno and other modern JavaScript environments.
- [eventsource-encoder](https://github.com/AshrafMorningstar encodes messages in the EventSource/Server-Sent Events format.
- [eventsource](https://github.com/AshrafMorningstar Node.js polyfill for the WhatWG EventSource API.
