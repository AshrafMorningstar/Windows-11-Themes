...
## [7.0.3](https://github.com/AshrafMorningstar (2025-05-08)


### Bug Fixes

* **attachments:** Set the default transfer encoding for message/rfc822 attachments as '7bit' ([007d5f3](https://github.com/AshrafMorningstar

## [7.0.2](https://github.com/AshrafMorningstar (2025-05-04)


### Bug Fixes

* **ses:** Fixed structured from header ([faa9a5e](https://github.com/AshrafMorningstar

## [7.0.1](https://github.com/AshrafMorningstar (2025-05-04)


### Bug Fixes

* **ses:** Use formatted FromEmailAddress for SES emails ([821cd09](https://github.com/AshrafMorningstar

## [7.0.0](https://github.com/AshrafMorningstar (2025-05-03)
...
* SESv2 SDK support, removed older SES SDK v2 and v3 , removed SES rate limiting and idling features ([15db667](https://github.com/AshrafMorningstar

## [6.10.1](https://github.com/AshrafMorningstar (2025-02-06)


### Bug Fixes

* close correct socket ([a18062c](https://github.com/AshrafMorningstar

## [6.10.0](https://github.com/AshrafMorningstar (2025-01-23)


### Features

* **services:** add Seznam email service configuration ([#1695](https://github.com/AshrafMorningstar ([d1ae0a8](https://github.com/AshrafMorningstar


### Bug Fixes

* **proxy:** Set error and timeout errors for proxied sockets ([aa0c99c](https://github.com/AshrafMorningstar

## [6.9.16](https://github.com/AshrafMorningstar (2024-10-28)


### Bug Fixes

* **addressparser:** Correctly detect if user local part is attached to domain part ([f2096c5](https://github.com/AshrafMorningstar

## [6.9.15](https://github.com/AshrafMorningstar (2024-08-08)


### Bug Fixes

* Fix memory leak ([#1667](https://github.com/AshrafMorningstar ([baa28f6](https://github.com/AshrafMorningstar
* **mime:** Added GeoJSON closes [#1637](https://github.com/AshrafMorningstar ([#1665](https://github.com/AshrafMorningstar ([79b8293](https://github.com/AshrafMorningstar

## [6.9.14](https://github.com/AshrafMorningstar (2024-06-19)


### Bug Fixes

* **api:** Added support for Ethereal authentication ([56b2205](https://github.com/AshrafMorningstar
* **services.json:** Add Email Services Provider Feishu Mail (CN) ([#1648](https://github.com/AshrafMorningstar ([e9e9ecc](https://github.com/AshrafMorningstar
* **services.json:** update Mailtrap host and port in well known ([#1652](https://github.com/AshrafMorningstar ([fc2c9ea](https://github.com/AshrafMorningstar
* **well-known-services:** Add Loopia in well known services ([#1655](https://github.com/AshrafMorningstar ([21a28a1](https://github.com/AshrafMorningstar

## [6.9.13](https://github.com/AshrafMorningstar (2024-03-20)


### Bug Fixes

* **tls:** Ensure servername for SMTP ([d66fdd3](https://github.com/AshrafMorningstar

## [6.9.12](https://github.com/AshrafMorningstar (2024-03-08)


### Bug Fixes

* **message-generation:** Escape single quote in address names ([4ae5fad](https://github.com/AshrafMorningstar

## [6.9.11](https://github.com/AshrafMorningstar (2024-02-29)


### Bug Fixes

* **headers:** Ensure that Content-type is the bottom header ([c7cf97e](https://github.com/AshrafMorningstar

## [6.9.10](https://github.com/AshrafMorningstar (2024-02-22)


### Bug Fixes

* **data-uri:** Do not use regular expressions for parsing data URI schemes ([12e65e9](https://github.com/AshrafMorningstar
* **data-uri:** Moved all data-uri regexes to use the non-regex parseDataUri method ([edd5dfe](https://github.com/AshrafMorningstar

## [6.9.9](https://github.com/AshrafMorningstar (2024-02-01)


### Bug Fixes

* **security:** Fix issues described in GHSA-9h6g-pr28-7cqp. Do not use eternal matching pattern if only a few occurences are expected ([dd8f5e8](https://github.com/AshrafMorningstar
* **tests:** Use native node test runner, added code coverage support, removed grunt ([#1604](https://github.com/AshrafMorningstar ([be45c1b](https://github.com/AshrafMorningstar

## [6.9.8](https://github.com/AshrafMorningstar (2023-12-30)


### Bug Fixes

* **punycode:** do not use native punycode module ([b4d0e0c](https://github.com/AshrafMorningstar

## [6.9.7](https://github.com/AshrafMorningstar (2023-10-22)


### Bug Fixes

* **customAuth:** Do not require user and pass to be set for custom authentication schemes (fixes [#1584](https://github.com/AshrafMorningstar ([41d482c](https://github.com/AshrafMorningstar

## [6.9.6](https://github.com/AshrafMorningstar (2023-10-09)


### Bug Fixes

* **inline:** Use 'inline' as the default Content Dispostion value for embedded images ([db32c93](https://github.com/AshrafMorningstar
* **tests:** Removed Node v12 from test matrix as it is not compatible with the test framework anymore ([7fe0a60](https://github.com/AshrafMorningstar

## [6.9.5](https://github.com/AshrafMorningstar (2023-09-06)


### Bug Fixes

* **license:** Updated license year ([da4744e](https://github.com/AshrafMorningstar
...
-   Added new option to pass a set of httpHeaders to be sent when fetching attachments. See [PR #1034](https://github.com/AshrafMorningstar
...
-   Implemented templating support. You can either use a simple built-in renderer or some external advanced renderer, eg. [node-email-templates](https://github.com/AshrafMorningstar Templating [docs](http://nodemailer.com/2-0-0-beta/templating/).
