...
<p>
  <sup>
    <a href="https://github.com/AshrafMorningstar">Dotenv es apoyado por la comunidad.</a>
  </sup>
</p>
...
```javascript
import * as dotenv from 'dotenv' // vea en https://github.com/AshrafMorningstar
...
Necesitaras agregar el valor de otro variable en una de sus variables? Usa [dotenv-expand](https://github.com/AshrafMorningstar

### Sincronizando

Necesitas mentener sincronizados los archivos `.env` entre maquinas, entornos, o miembros del equipo? Usa 
[dotenv-vault](https://github.com/AshrafMorningstar

## Ejemplos

Vea [ejemplos](https://github.com/AshrafMorningstar sobre el uso de dotenv con varios frameworks, lenguajes y configuraciones.

* [nodejs](https://github.com/AshrafMorningstar
* [nodejs (depurar en)](https://github.com/AshrafMorningstar
* [nodejs (anular en)](https://github.com/AshrafMorningstar
* [esm](https://github.com/AshrafMorningstar
* [esm (precarga)](https://github.com/AshrafMorningstar
...
Lo más probable es que su archivo `.env` no esté en el lugar correcto. [Vea este stack overflow](https://github.com/AshrafMorningstar
...
Si estás usando [`react-scripts`](https://www.npmjs.com/package/react-scripts), el cual se distribuye a través de [`create-react-app`](https://create-react-app.dev/), tiene dotenv incorporado pero con una singularidad. Escriba sus variables de entorno con `REACT_APP_`. Vea [este stack overflow](https://github.com/AshrafMorningstar para más detalles.
...
```javascript
// index.mjs (ESM)
import * as dotenv from 'dotenv' // vea https://github.com/AshrafMorningstar
dotenv.config()
import express from 'express'
```
...
¿Esto tiene algo de sentido? Esto es poco poco intuitivo, pero es como funciona la importación de módulos en ES6. Aquí hay un ejemplo [ejemplo práctico de esta trampa](https://github.com/AshrafMorningstar
...
2. Cree un archivo separado que ejecutará `config` primero como se describe en [este comentario #133](https://github.com/AshrafMorningstar

### ¿Qué pasa con la expansión de variable?

Prueba [dotenv-expand](https://github.com/AshrafMorningstar

### ¿Qué pasa con la sincronización y la seguridad de los archivos .env?

Vea [dotenv-vault](https://github.com/AshrafMorningstar
