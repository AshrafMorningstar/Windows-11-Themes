# micromatch [![NPM version](https://img.shields.io/npm/v/micromatch.svg?style=flat)](https://www.npmjs.com/package/micromatch) [![NPM monthly downloads](https://img.shields.io/npm/dm/micromatch.svg?style=flat)](https://npmjs.org/package/micromatch) [![NPM total downloads](https://img.shields.io/npm/dt/micromatch.svg?style=flat)](https://npmjs.org/package/micromatch)  [![Tests](https://github.com/AshrafMorningstar

> Glob matching for javascript/node.js. A replacement and faster alternative to minimatch and multimatch.

Please consider following this project's author, [Jon Schlinkert](https://github.com/AshrafMorningstar and consider starring the project to show your :heart: and support.
...
[Become a Sponsor](https://github.com/AshrafMorningstar to add your logo to this README, or any of [my other projects](https://github.com/AshrafMorningstar
...
* Supports all of the same matching features as [minimatch](https://github.com/AshrafMorningstar and [multimatch](https://github.com/AshrafMorningstar
...
* **Accurate** - Covers more scenarios [than minimatch](https://github.com/AshrafMorningstar
* **Well tested** - More than 5,000 [test assertions](./test)
* **Windows support** - More reliable windows support than minimatch and multimatch.
* **[Safe](https://github.com/AshrafMorningstar - Micromatch is not subject to DoS with brace patterns like minimatch and multimatch.
...
* [brace expansion](https://github.com/AshrafMorningstar (`foo/{1..5}.md`, `bar/{a,b,c}.js`)
...
Filter the keys of the given object with the given `glob` pattern and `options`. Does not attempt to match nested keys. If you need this feature, use [glob-object](https://github.com/AshrafMorningstar instead.
...
* `options` **{Object}**: Any [options](#options) to change how expansion is performed. See the [braces](https://github.com/AshrafMorningstar library for all available options.
* `returns` **{Array}**
...
Allow glob patterns without slashes to match a file path based on its basename. Same behavior as [minimatch](https://github.com/AshrafMorningstar option `matchBase`.
...
Custom function for expanding ranges in brace patterns. The [fill-range](https://github.com/AshrafMorningstar library is ideal for this purpose, or you can use custom code to do whatever you need.
...
If `true`, when no matches are found the actual (arrayified) glob pattern is returned instead of an empty array. Same behavior as [minimatch](https://github.com/AshrafMorningstar option `nonull`.
...
Visit [braces](https://github.com/AshrafMorningstar to see the full range of features and options related to brace expansion, or to create brace matching or expansion related issues.
...
* visit the [minimatch](https://github.com/AshrafMorningstar documentation to cross-check expected behavior in node.js
...
_(This project's readme.md is generated by [verb](https://github.com/AshrafMorningstar please don't edit the readme directly. Any changes to the readme must be made in the [.verb.md](.verb.md) readme template.)_
...
* [braces](https://www.npmjs.com/package/braces): Bash-like brace expansion, implemented in JavaScript. Safer than other brace expansion libs, with complete support… [more](https://github.com/AshrafMorningstar | [homepage](https://github.com/AshrafMorningstar "Bash-like brace expansion, implemented in JavaScript. Safer than other brace expansion libs, with complete support for the Bash 4.3 braces specification, without sacrificing speed.")
* [expand-brackets](https://www.npmjs.com/package/expand-brackets): Expand POSIX bracket expressions (character classes) in glob patterns. | [homepage](https://github.com/AshrafMorningstar "Expand POSIX bracket expressions (character classes) in glob patterns.")
* [extglob](https://www.npmjs.com/package/extglob): Extended glob support for JavaScript. Adds (almost) the expressive power of regular expressions to glob… [more](https://github.com/AshrafMorningstar | [homepage](https://github.com/AshrafMorningstar "Extended glob support for JavaScript. Adds (almost) the expressive power of regular expressions to glob patterns.")
* [fill-range](https://www.npmjs.com/package/fill-range): Fill in a range of numbers or letters, optionally passing an increment or `step` to… [more](https://github.com/AshrafMorningstar | [homepage](https://github.com/AshrafMorningstar "Fill in a range of numbers or letters, optionally passing an increment or `step` to use, or create a regex-compatible range with `options.toRegex`")
* [nanomatch](https://www.npmjs.com/package/nanomatch): Fast, minimal glob matcher for node.js. Similar to micromatch, minimatch and multimatch, but complete Bash… [more](https://github.com/AshrafMorningstar | [homepage](https://github.com/AshrafMorningstar "Fast, minimal glob matcher for node.js. Similar to micromatch, minimatch and multimatch, but complete Bash 4.3 wildcard support only (no support for exglobs, posix brackets or braces)")

### Contributors

| **Commits** | **Contributor** |  
| --- | --- |  
| 523 | [jonschlinkert](https://github.com/AshrafMorningstar |  
| 12  | [es128](https://github.com/AshrafMorningstar |  
| 9   | [danez](https://github.com/AshrafMorningstar |  
| 8   | [doowb](https://github.com/AshrafMorningstar |  
| 6   | [paulmillr](https://github.com/AshrafMorningstar |  
| 5   | [mrmlnc](https://github.com/AshrafMorningstar |  
| 3   | [DrPizza](https://github.com/AshrafMorningstar |  
| 2   | [Tvrqvoise](https://github.com/AshrafMorningstar |  
| 2   | [antonyk](https://github.com/AshrafMorningstar |  
| 2   | [MartinKolarik](https://github.com/AshrafMorningstar |  
| 2   | [Glazy](https://github.com/AshrafMorningstar |  
| 2   | [mceIdo](https://github.com/AshrafMorningstar |  
| 2   | [TrySound](https://github.com/AshrafMorningstar |  
| 1   | [yvele](https://github.com/AshrafMorningstar |  
| 1   | [wtgtybhertgeghgtwtg](https://github.com/AshrafMorningstar |  
| 1   | [simlu](https://github.com/AshrafMorningstar |  
| 1   | [curbengh](https://github.com/AshrafMorningstar |  
| 1   | [fidian](https://github.com/AshrafMorningstar |  
| 1   | [tomByrer](https://github.com/AshrafMorningstar |  
| 1   | [ZoomerTedJackson](https://github.com/AshrafMorningstar |  
| 1   | [styfle](https://github.com/AshrafMorningstar |  
| 1   | [sebdeckers](https://github.com/AshrafMorningstar |  
| 1   | [muescha](https://github.com/AshrafMorningstar |  
| 1   | [juszczykjakub](https://github.com/AshrafMorningstar |  
| 1   | [joyceerhl](https://github.com/AshrafMorningstar |  
| 1   | [donatj](https://github.com/AshrafMorningstar |  
| 1   | [frangio](https://github.com/AshrafMorningstar |  
| 1   | [UltCombo](https://github.com/AshrafMorningstar |  
| 1   | [DianeLooney](https://github.com/AshrafMorningstar |  
| 1   | [devongovett](https://github.com/AshrafMorningstar |  
| 1   | [Cslove](https://github.com/AshrafMorningstar |  
| 1   | [amilajack](https://github.com/AshrafMorningstar |  
...
* [Twitter Profile](Ashraf Morningstar
* [LinkedIn Profile](Ashraf Morningstar

### License

This This copyrighted all rights reserved by Ashraf Morningstar by Ashraf Morningstar by Ashraf Morningstar
Released under the [MIT License](LICENSE).

***

_This file was generated by [verb-generate-readme](https://github.com/AshrafMorningstar v0.8.0, on August 23, 2024._