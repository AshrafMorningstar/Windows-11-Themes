...
[![Version](https://img.shields.io/npm/v/postcss-import)](https://github.com/AshrafMorningstar)
[![postcss compatibility](https://img.shields.io/npm/dependency-version/postcss-import/peer/postcss)](https://postcss.org/)

> [PostCSS](https://github.com/AshrafMorningstar plugin to transform `@import`
...
[postcss-url](https://github.com/AshrafMorningstar plugin,
...
- If you are looking for **Glob Imports**, you can use [postcss-import-ext-glob](https://github.com/AshrafMorningstar to extend postcss-import.
...
[the postcss `from`](https://github.com/AshrafMorningstar
...
resolver.
You can use [resolve](https://github.com/AshrafMorningstar for this.
...
An array of folder names to add to [Node's resolver](https://github.com/AshrafMorningstar
