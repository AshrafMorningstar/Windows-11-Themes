...
- Passes all of the [yaml-test-suite](https://github.com/AshrafMorningstar tests,
- Can accept any string as input without throwing, parsing as much YAML out of it as it can, and
- Supports parsing, modifying, and writing YAML comments and blank lines.

The library is released under the ISC open source license, and the code is [available on GitHub](https://github.com/AshrafMorningstar
...
**Note:** These docs are for `yaml@2`. For v1, see the [v1.10.0 tag](https://github.com/AshrafMorningstar for the source and [eemeli.org/yaml/v1](https://eemeli.org/yaml/v1/) for the documentation.

The development and maintenance of this library is [sponsored](https://github.com/AshrafMorningstar by:
