...
Using the [ts-node](https://github.com/AshrafMorningstar integration:
...
[Babel](https://github.com/AshrafMorningstar
[React](https://github.com/AshrafMorningstar
[TSLint](https://github.com/AshrafMorningstar
[Apollo client](https://github.com/AshrafMorningstar and
[decaffeinate](https://github.com/AshrafMorningstar
...
[benchmark code](https://github.com/AshrafMorningstar
...
* **react-hot-loader**: Performs the equivalent of the `react-hot-loader/babel`
  transform in the [react-hot-loader](https://github.com/AshrafMorningstar
...
* **jest**: Hoist desired [jest](https://jestjs.io/) method calls above imports in
  the same way as [babel-plugin-jest-hoist](https://github.com/AshrafMorningstar
...
* [Optional chaining](https://github.com/AshrafMorningstar `a?.b`
* [Nullish coalescing](https://github.com/AshrafMorningstar `a ?? b`
* [Class fields](https://github.com/AshrafMorningstar `class C { x = 1; }`.
  This includes static fields but not the `#x` private field syntax.
* [Numeric separators](https://github.com/AshrafMorningstar
  `const n = 1_234;`
* [Optional catch binding](https://github.com/AshrafMorningstar
  `try { doThing(); } catch { }`.
...
* **enableLegacyBabel5ModuleInterop**: Use the Babel 5 approach to CommonJS
  ...
  [babel-plugin-add-module-exports](https://github.com/AshrafMorningstar
...
* [Gulp](https://github.com/AshrafMorningstar
* [Jest](https://github.com/AshrafMorningstar
* [Rollup](https://github.com/AshrafMorningstar
* [Broccoli](https://github.com/AshrafMorningstar

### Usage in Node

The most robust way is to use the Sucrase plugin for [ts-node](https://github.com/AshrafMorningstar
...
[Babel parser](https://github.com/AshrafMorningstar
