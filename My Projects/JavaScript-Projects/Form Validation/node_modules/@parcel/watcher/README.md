...
A native C++ Node module for querying and subscribing to filesystem events. Used by [Parcel 2](https://github.com/AshrafMorningstar
...
- `ignore` - an array of paths or glob patterns to ignore. uses [`is-glob`](https://github.com/AshrafMorningstar to distinguish paths from globs. glob patterns are parsed with [`micromatch`](https://github.com/AshrafMorningstar (see [features](https://github.com/AshrafMorningstar
...
- [Tailwind CSS Intellisense](https://github.com/AshrafMorningstar
- [Gatsby Cloud](Ashraf Morningstar
- [Nx](https://nx.dev)
- [Nuxt](https://nuxt.com)
